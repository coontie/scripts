...
#print header;
print "<b>Wachovia EMS status report.  Generated on $fullDate.</b>";
print "<p>";
print "Click on a link to show a 36hr past history.";
print "<p>";
...
#        }
	...
	#strip out tcp:// and the port # from the url
	my $serverName=substr $url, 6, -5;

	my $pendMsgFilename=$serverName."\.pendingMessageCount.gif";
	$pendMessages="<A HREF=\"graphs/$pendMsgFilename\">$pendMessages</A>";

	my $connsFilename=$serverName."\.connectionCount.gif";
	$connections="<A HREF=\"graphs/$connsFilename\">$connections</A>";
